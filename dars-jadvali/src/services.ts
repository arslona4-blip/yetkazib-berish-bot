...
export const SERVICES: ServiceDef[] = [
  ...
  { id: 'homework', titleUz: 'Uyga vazifa', titleRu: 'Домашнее', descUz: 'Vazifalar ro‘yxati', descRu: 'Список заданий', tone: 'rose', icon: 'homework', featured: true },
  ...
  { id: 'checklist', titleUz: 'Ertalabki reja', titleRu: 'Утро', descUz: 'Nima olish kerak', descRu: 'Что взять', tone: 'slate', icon: 'checklist' },
